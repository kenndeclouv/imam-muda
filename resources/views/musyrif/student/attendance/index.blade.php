    ...
    <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card-body">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Daftar Kehadiran Santri</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="card">
            <div class="card-header border-bottom mb-4">
                <h5 class="card-title">Daftar Kehadiran Santri</h5>
            </div>
            <div class="card-body pb-0">
                @include('components.alert')
                <div class="card-actions d-flex">
                    <a href="{{ route('musyrif.student.attendance.create') }}" class="btn btn-primary ms-auto">Tambah
                        Kehadiran</a>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2" aria-label="Basic example">
                                        <a href="{{ route('musyrif.student.attendance.show', $attendance->id) }}"
                                            class="btn btn-info" data-bs-toggle="tooltip" data-bs-placement="top"
                                            data-bs-title="Detail Kehadiran">
                                            <i class="fa-solid fa-eye"></i>
                                        </a>
                                        <a href="{{ route('musyrif.student.attendance.edit', $attendance->id) }}"
                                            class="btn btn-warning" data-bs-toggle="tooltip" data-bs-placement="top"
                                            data-bs-title="Edit Kehadiran">
                                            <i class="fa-solid fa-edit"></i>
                                        </a>
                                        <x-confirm-delete :route="route('musyrif.student.attendance.destroy', $attendance->id)" title="Hapus Kehadiran"
                                            message="Apakah anda yakin ingin menghapus kehadiran ini?" />
                                    </div>
                                </td>
                            </tr>
                        @endforeach
