    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card mb-6">
            <div class="card-header border-bottom mb-4 d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Edit Kehadiran Kamu</h5> <small class="text-body float-end">Data Kehadiran
                    Kamu</small>
            </div>
            <div class="card-body">
                @include('components.alert')
                <form action="{{ route('student.student.attendance.update', $attendance->id) }}" method="POST">
                    @csrf
                    @method('PUT')
