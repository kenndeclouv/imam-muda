        ...
        <div class="card">
            ...
            <div class="card-body pb-0">
                ...
                <div class="card-actions d-flex">
                    <a href="{{ route('imam.student.memorization.create') }}" class="btn btn-primary ms-auto">Tambah
                        Hafalan</a>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2" aria-label="Basic example">
                                        <a href="{{ route('imam.student.memorization.show', $memorization->id) }}"
                                            class="btn btn-info" data-bs-toggle="tooltip" data-bs-placement="top"
                                            data-bs-title="Detail Hafalan">
                                            <i class="fa-solid fa-eye"></i>
                                        </a>
                                        <a href="{{ route('imam.student.memorization.edit', $memorization->id) }}"
                                        ...
                                        <div class="dropdown" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <li>
                                                    <form
                                                        action="{{ route('imam.student.memorization.isContinueTrue', $memorization->id) }}"
                                                ...
                                                <li>
                                                    <form
                                                        action="{{ route('imam.student.memorization.isContinueFalse', $memorization->id) }}"
                                                        method="POST" style="display:inline;">
                                                        @csrf
                                                        <button type="submit" class="dropdown-item text-danger">Tidak
                                                            Lulus</button>
                                                    </form>
                                                </li>
                                            </ul>
                                        </div>
                                        <x-confirm-delete :route="route('imam.student.memorization.destroy', $memorization->id)" title="Hapus Hafalan"
