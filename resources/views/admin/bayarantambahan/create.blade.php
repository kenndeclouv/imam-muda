    ...
    <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card-body">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Tambah Bayaran Tambahan</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="card mb-6">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.bayarantambahan.store') }}" method="POST">
                    @csrf
                    <div class="mb-6">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" name="bayaran_tambahan" class="form-control" id="bayaran_tambahan" placeholder="Rp."
                            value="{{ old('bayaran_tambahan') }}" required min="0">
                    </div>
