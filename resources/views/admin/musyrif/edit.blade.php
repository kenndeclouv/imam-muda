    ...
    <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card-body">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.musyrif.index') }}">Daftar Musyrif</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Edit Musyrif</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="bs-stepper wizard-numbered mt-2">
            ...
            <div class="bs-stepper-content">
                <form action="{{ route('admin.musyrif.update', $musyrif->id) }}" method="POST"
                    ...
                    <div id="account-details" class="content active dstepper-block">
                        ...
                        <div class="row g-6">
                            <div class="col-sm-6">
                                <label class="form-label" for="username">Username Musyrif</label>
                                <input type="text" id="username" class="form-control" placeholder="johndoe"
                                    name="username" value="{{ old('username', $musyrif->User->username) }}">
                            </div>
                            <div class="col-sm-6">
                                <label class="form-label" for="email">Email</label>
                                <input type="email" id="email" class="form-control"
                                    placeholder="john.doe@email.com" aria-label="john.doe" name="email"
                                    value="{{ old('email', $musyrif->User->email) }}">
                            </div>
                        ...
                        <div class="row g-6">
                            <div class="col-sm-6">
                                ...
                                <input type="text" id="first-name" class="form-control" placeholder="Nama Lengkap"
                                    name="fullname" value="{{ old('fullname', $musyrif->fullname) }}">
                            </div>
                            <div class="col-sm-6">
                                ...
                                <input type="text" id="tempat-lahir" class="form-control"
                                    ...
                                    value="{{ old('birthplace', $musyrif->birthplace) }}">
                            </div>
                            <div class="col-sm-6">
                                ...
                                <input type="date" id="tanggal-lahir" class="form-control" name="birthdate"
                                    value="{{ old('birthdate', $musyrif->birthdate) }}">
                            </div>
                            <div class="col-12 d-flex justify-content-between">
                        ...
                        <div class="row g-6">
                            <div class="col-sm-6">
                                ...
                                <input type="text" id="phone" class="form-control"
                                    ...
                                    value="{{ old('phone', $musyrif->phone) }}">
                            </div>
                            <div class="col-sm-6">
                                <label class="form-label" for="address">Alamat</label>
                                <input type="text" id="address" class="form-control"
                                    placeholder="Alamat Lengkap" name="address"
                                    value="{{ old('address', $musyrif->address) }}">
                            </div>
                            <div class="col-sm-12">
                                <label class="form-label" for="description">Catatan</label>
                                <textarea id="description" class="form-control" placeholder="Tambahkan Catatan" rows="3" name="description">{{ old('description', $musyrif->description) }}</textarea>
                            </div>
                            <div class="col-12 d-flex justify-content-between">
                                <button class="btn btn-primary btn-prev" type="button">
                                    <i class="fa fa-chevron-left fa-sm ms-sm-n2 me-sm-2"></i>
