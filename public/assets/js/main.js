            ...
            i =
                (window.templateCustomizer &&
                    ...
                    "light" === l
                        ...
                        : (i.classList.add("fa-solid", "fa-desktop"),
                          new bootstrap.Tooltip(i, {
                              title: "System Mode",
                              fallbackPlacements: ["bottom"],
                          }))),
                        ...
                        .typeahead(
                            ...
                            },
                            {
                                ...
                                templates: {
                                    ...
                                    notFound:
                                        '<div class="not-found px-3 py-2"><h6 class="suggestions-header text-primary mb-2">Pages</h6><p class="py-2 mb-0"><i class="fas fa-error-circle fa-xs me-2"></i> No Results Found</p></div>',
                                },
                            },
                            {
                                name: "files",
                                ...
                                templates: {
                                    ...
                                    notFound:
                                        '<div class="not-found px-3 py-2"><h6 class="suggestions-header text-primary mb-2">Files</h6><p class="py-2 mb-0"><i class="fas fa-error-circle fa-xs me-2"></i> No Results Found</p></div>',
                                },
                            },
                            {
                                name: "members",
                                ...
                                templates: {
                                    ...
                                    notFound:
                                        '<div class="not-found px-3 py-2"><h6 class="suggestions-header text-primary mb-2">Members</h6><p class="py-2 mb-0"><i class="fas fa-error-circle fa-xs me-2"></i> No Results Found</p></div>',
                                },
                            }
                        )
